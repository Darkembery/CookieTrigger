...
function scr_save_all()
{
	...
	ini_write_real("Enemys", "Enemy3", global.enemy3_kills);
	ini_write_real("Enemys", "Enemy4", global.enemy4_kills);
...
if (ini_key_exists("cooldown_upgrade", "max_level")) {
    var current_max = ini_read_real("cooldown_upgrade", "max_level", 10);
    
    if (current_max < 12) {
        ini_write_real("cooldown_upgrade", "max_level", 12);
        ini_write_real("timer_upgrade", "max_level", 12);
        ini_write_real("ammo_upgrade", "max_level", 12);
        ini_write_real("damage_upgrade", "max_level", 12);
    }
}
ini_close()
	...
	ini_open("save.ini")
        ...
        global.cooldown_upgrade_max_level = ini_read_real("cooldown_upgrade", "max_level", 12);
        ...
        global.timer_upgrade_max_level    = ini_read_real("timer_upgrade", "max_level", 12);
        ...
        global.ammopc_upgrade_max_level   = ini_read_real("ammo_upgrade", "max_level", 12);
        ...
        global.damage_upgrade_max_level   = ini_read_real("damage_upgrade", "max_level", 12);
		...
		global.enemy3_kills				  = ini_read_real("Enemys", "Enemy3", 0);
		global.enemy4_kills				  = ini_read_real("Enemys", "Enemy4", 0);
